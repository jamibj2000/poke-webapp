...
activatePokedex=(active = pokedexActive)=>{
    if (active) {
        ...
        <div id="pokemonDiv" class="data-card bg-success p-2 rounded d-flex align-items-center justify-content-center flex-column"></div></div>`
...
//D4NAdERILmXbNUFXQPQeVnRpmKI6PMpM
//HIZ32wdVSoUfGxHM